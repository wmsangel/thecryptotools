...
export const houseAds: HouseAd[] = [
  ...
  },
  {
    ...
    title: "100 tiny tools that do one thing, fast",
    description: "Image, SEO, developer, calculator and generator tools — in your browser, no signup.",
    cta: "Open IZN Tools",
  },
  {
    id: "testsweep",
    ...
    lang: "en",
    eyebrow: "Test your PC",
    title: "Check your screen & PC in the browser",
    description: "Dead-pixel, refresh-rate, colour and backlight tests. Nothing to install, nothing uploaded.",
    cta: "Open TestSweep",
  },
  {
    id: "prodom-expert",
